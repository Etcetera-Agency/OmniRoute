...
export const NOAUTH_PROVIDERS = {
  ...
  mdream: {
    ...
    color: "#14B8A6",
    textIcon: "MD",
    website: "https://mdream.dev",
    noAuth: true,
    hasFree: true,
    serviceKinds: ["webFetch"],
    freeNote: "Free public Markdown/text extraction for public URLs. No API key required.",
    authHint: "No credentials required — Mdream is used as a keyless web-fetch provider.",
  },
  theoldllm: {
    id: "theoldllm",
    alias: "tllm",
